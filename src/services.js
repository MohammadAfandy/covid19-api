...
exports.updateDataProvince = () => new Promise(async (resolve, reject) => {
  try {
    ...
    resolve(data_province);
  } catch (error) {
    reject(error);
  }
});

exports.updateDataAll = () => new Promise(async (resolve, reject) => {
  try {
...
exports.updateDataDaily = () => new Promise(async (resolve, reject) => {
  try {
...
exports.updateDataListProvinces = () => new Promise(async (resolve, reject) => {
  try {
